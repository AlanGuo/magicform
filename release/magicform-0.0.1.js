...
(function(exports) {
    var template = {
        ...
        formLabelItemTemplate: /*<MFFormLabelItemTemplate>*/'<label class="<%=data[p].classname?data[p].classname.label:options.classname.label%>" style="<%=data[p].style?data[p].style.label:options.style.label%>" for="formitem-<%=p%>" data-key="formitem-<%=p%>"><%=data[p].label?data[p].label:p%></label>'/*</MFFormLabelItemTemplate>*/,
        ...
        formpanelTemplate: /*<MFFormPanelTemplate>*/'<div class="<%=options.classname.formpanel%>"><label class="<%=options.classname.label%>" style="<%=options.style.label%>"></label><%for(var i=0;i<options.buttons.length;i++){%><%if(options.buttons[i].submit){%><button class="<%=options.buttons[i].className%>" title="<%=options.buttons[i].title%>"><%=options.buttons[i].name%></button><%}else{%><button class="ml15 <%=options.buttons[i].className%>" title="<%=options.buttons[i].title%>"><%=options.buttons[i].name%></button><%}%><%}%></div>'/*</MFFormPanelTemplate>*/
    };
