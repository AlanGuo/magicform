...
(function(exports) {
    var template = {
        ...
        formLabelItemTemplate: /*<MFFormLabelItemTemplate>*/'<label class="formitem-label <%=data[p].classname?data[p].classname.label:options.classname.label%>" style="<%=data[p].style?data[p].style.label:options.style.label%>" for="formitem-<%=p%>" data-key="formitem-<%=p%>"><%=data[p].label?data[p].label:p%></label>'/*</MFFormLabelItemTemplate>*/,
