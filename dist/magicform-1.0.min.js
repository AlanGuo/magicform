!function(){function p(t,g){return(/string|function/.test(typeof g)?e:a)(t,g)}function s(a,g){return"string"!=typeof a&&(g=typeof a,"number"===g?a+="":a="function"===g?s(a.call(a)):""),a}function u(a){return n[a]}function a(a,g){var f=p.get(a)||b({filename:a,name:"Render Error",message:"Template not found"});return g?f(g):f}function e(a,g){if("string"==typeof g){var v=g;g=function(){return new f(v)}}var m=k[a]=function(f){try{return new g(f,a)+""}catch(c){return b(c)()}};return m.prototype=g.prototype=
...
e+='" ',e+=g(b.label.attr),e+=">",e+=g(b.label.title),e+="</label>",new f(e)});p("formPanelTemplate",function(a){var g=(this.$helpers,this.$escape),b=a.options,e=this.$each,h=(a.op,a.$index,"");return h+='<div class="',h+=g(b.formpanel.classname),h+='"> <label class="formitem-label ',h+=g(b.label.classname),h+='" style="',h+=g(b.label.style),h+='" ',h+=g(b.attr.label),h+="></label> ",e(b.buttons,function(a){h+=" ";a.submit?(h+=' <button class="',h+=g(a.className),h+='" title="',h+=g(a.title),h+='">',
h+=g(a.name),h+="</button> "):(h+=' <button class="ml15 ',h+=g(a.className),h+='" title="',h+=g(a.title),h+='">',h+=g(a.name),h+="</button> ");h+=" "}),h+=" </div>",new f(h)})}();"use strict";
...
a.label.classname||"w20p align-right mr10p";a.label.attr=a.label.attr||"";a.itemwrapper=a.itemwrapper||{};a.itemwrapper.style=a.itemwrapper.style||"";a.itemwrapper.classname=a.itemwrapper.classname||"";a.itemwrapper.attr=a.itemwrapper.attr||"";a.formpanel=a.formpanel||{};a.formpanel.style=a.formpanel.style||"";a.formpanel.classname=a.formpanel.classname||"formpanel mt30";a.formpanel.attr=a.formpanel.attr||"";a.array=a.array||{};a.attr=a.attr||{};return a},_predefineValue:function(a,e,b){var k=Object.prototype.toString,
