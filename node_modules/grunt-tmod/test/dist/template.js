...
b("copyright","(c) 2013 "),/*v:24*/
b("index",function(b,c){"use strict";var d=this,e=(d.$helpers,function(a,e){e=e||b;var f=d.$include(a,e,c);return j+=f}),f=d.$escape,g=b.title,h=d.$each,i=b.list,j=(b.$value,b.$index,"");return e("./public/header"),j+=' <div id="main"> <h3>',j+=f(g),j+="</h3> <ul> ",h(i,function(a){j+=' <li><a href="',j+=f(a.url),j+='">',j+=f(a.title),j+="</a></li> "}),j+=" </ul> </div> ",e("./public/footer"),j+=" ",new a(j)}),/*v:11*/
b("public/footer",function(b,c){"use strict";var d=this,e=b.time,f=d.$escape,g=function(a,e){e=e||b;var f=d.$include(a,e,c);return h+=f},h="";return h+='<div id="footer"> ',e&&(h+=" <p class='time'>",h+=f(e),h+="</p> "),h+=" ",g("../copyright"),h+=" </div>",new a(h)}),/*v:11*/
b("public/header",function(b,c){"use strict";var d=this,e=function(a,e){e=e||b;var g=d.$include(a,e,c);return f+=g},f="";return f+=' <div id="header"> ',e("./logo"),f+=' <ul id="nav"> <li><a href="http://www.qq.com">首页</a></li> <li><a href="http://news.qq.com/">新闻</a></li> <li><a href="http://pp.qq.com/">图片</a></li> <li><a href="http://mil.qq.com/">军事</a></li> </ul> </div>  ',new a(f)}),/*v:11*/
b("public/logo",' <h1 id="logo"> <a href="http://www.qq.com"> <img width=\'134\' height=\'44\' src="http://mat1.gtimg.com/www/images/qq2012/qqlogo_1x.png" alt="腾讯网" /> </a> </h1> ')}();